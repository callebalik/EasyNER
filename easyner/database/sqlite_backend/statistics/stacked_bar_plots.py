...
class EntityDistributionPlotter:
    ...
    def setup_plot_parameters(self) -> None:
    ...
    def create_percentage_subplot(self) -> None:
    ...
    def create_counts_subplot(self) -> None:
    ...
    def _add_text_labels_to_count_bars(self):
        ...
        for i, (ambig, mislab, valid) in enumerate(
            zip(self.ambig_counts, self.mislab_counts, self.valid_counts, strict=False),
        ):
            # Ambiguous segment
            if ambig > 10:
                log_mid_point = (
    ...
    def apply_label_highlighting(self) -> None:
    ...
    def add_legend_and_title(self) -> None:
...
def plot_stacked_bar(entity_stats) -> None:
