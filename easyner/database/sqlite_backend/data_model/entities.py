...
class EntityOccurrence:
    ...
    def validate_normalized_entities(
        ...
        def validate_write_function(batch):
            ...
            self.logger.info("Writing mismatched entities to file to results folder.")
    ...
    def aggregate_normalized_text__CORRECT(
        ...
        self.logger.info("Aggregating distinct normalized texts")
    ...
    def create_view_error_lookup_inspection(self) -> None:
    ...
    def stats_aggregated(self) -> None:
    ...
    def validate_backreferences(self) -> bool | None:
...
class EntityCooccurence:
    ...
    def calc_fqs_uniq_doc_count_single_function(self) -> None:
        pass
    ...
    def co_calc_pmi(self, batch_size=200000) -> None:
        ...
        try:
            ...
            self.logger.info("PMI calculation complete")
