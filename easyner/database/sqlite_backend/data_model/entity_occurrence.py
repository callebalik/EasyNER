...
class SchemaManager(BaseComponent):
    ...
    def migrate_ne_table(self) -> None:
    ...
    def migrate_and_setup_ne_aggregation(self) -> bool | None:
    ...
    def migrate_docs_and_sentences_tables(self) -> bool:
        ...
        try:
            ...
            if docs_count > 0:
                ...
                if backup_count != docs_count:
                    ...
                    msg = "Backup validation failed - aborting migration"
                ...
                if not src_cols or not dest_cols:
                    ...
                    msg = "Migration failed - no common columns to migrate"
                    raise ValueError(msg)
...
class Preprocessor(BaseComponent):
    ...
    def populate_normalized_txt_column(self) -> None:
    ...
    def _batch_update_error_codes(
        ...
        try:
            ...
            with tqdm(
                total=total_batches,
                desc=f"Updating {ERROR_ID} for {TABLE_NE}",
            ) as pbar:
    ...
    def identity_overlap(self) -> None:
        ...
        ind = Index(
            TABLE_NE,
            [DOC_ID, SENT_IDX, SPAN_START, SPAN_END],
            logger=self.logger,
        )
        ind.create_if_not_exists(self.cursor)
...
class Analysis(BaseComponent):
    def record_entity_occurrences(self, batch_size=1000) -> bool | None:
...
class Aggregator(BaseComponent):
    ...
    def _validate_entity_aggregation(self):
        ...
        try:
            ...
            sample_size = min(
                10000,
                max(1000, int(aggregation_count * 0.01)),
...
class Tests(BaseComponent):
    ...
    def test_entity_occurrences(self) -> None:
    ...
    def test_for_invalid_references(self) -> None:
