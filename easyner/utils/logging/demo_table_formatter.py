...
from easyner.utils.logging.table_log_formatter import (
    TableLogFormatter,
    setup_table_logging,
)
...
def demo_direct_table_formatter() -> None:
...
def demo_table_log_formatter() -> None:
...
def demo_setup_table_logging() -> None:
...
class DataProcessor(TableLoggingMixin):
    ...
    def process(self, rows: int) -> None:
...
def demo_table_logging_mixin() -> None:
...
def demo_reader_writer_log() -> None:
