...
def run_co_occurrence(co_occuence_config: dict, ignore: bool):
    if ignore:
        print("Ignoring script: co_occurrence.")
        return

    print("Running co_occurrence script.")
    co_occurence.run(config["co_occurrence"])
    print("Finished running co_occurrence script.")
...
if __name__ == "__main__":
    ...
    # Run co-occurrence analysis on specified NER folder
    run_co_occurrence(config["co_occurrence"], ignore=ignore["co_occurrence"])
    print()
