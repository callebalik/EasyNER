...
def delete_old_logs_task(db_manager: DatabaseManager, logger: BaseLogger, table_name, date_column, days_ago):
    ...
    try:
        ...
        logger.info(f"Deleted {deleted_rows} old records from table '{table_name}' (older than {cutoff_date}).")
    except Exception as e:
