...
def init_routes(app, get_db, visualization_manager):
    ...
    get_db_simple_connection = app.get_db_simple_connection if hasattr(app, 'get_db_simple_connection') else None
    ...
    register_disease_phenomena_routes(app, get_db_simple_connection, visualization_manager)
