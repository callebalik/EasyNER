...
class TableLoggingMixin:
    ...
    def log_table(self, data: Dict[str, Any],
    ...
    def log_config_as_table(self, title: str = "Configuration", level: int = logging.INFO) -> None:
        """
    ...
    def log_reader_writer_config(self,
        ...
        if reader_threads is not None:
            config['Reader threads running'] = f"{reader_threads[0]}/{reader_threads[1]}"
