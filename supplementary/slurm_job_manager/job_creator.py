...
#SBATCH --gpus=6                # One GPU seems to be minimum for a job to be submitted
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="File containing batch intervals (JSON format)",
    )
    parser.add_argument(
        "--metadata-file",
        type=str,
        default="job_metadata.json",
        help="File to store job metadata",
    )
    parser.add_argument(
        "--setup-script",
        type=str,
